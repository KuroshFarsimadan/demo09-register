...
public class RegisterServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			response.sendRedirect("register?success=y");
			...
			takaisinVirheviestilla(errorMessage, username, request, response);
	...
	private void takaisinVirheviestilla(String message, String username, HttpServletRequest request,
