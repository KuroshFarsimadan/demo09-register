...
public class WebUserDAO extends DAO{
	 ...
	 * 
	 * @param wu WebUser information that will be added
	 * @throws UserNameReservedException If the database already has a webuser with the same username
	 * @throws DAOException If an database error occurred
	 */
